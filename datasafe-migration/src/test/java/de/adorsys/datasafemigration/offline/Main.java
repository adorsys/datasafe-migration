...
public class Main {
    ...
    private static S101_PathEncryptionConfig getNewPathEncryptionConfig(String prefix, String[] args) {
        return new S101_PathEncryptionConfig(Boolean.getBoolean(get(args, prefix + "-pathEncryption")));
    }
